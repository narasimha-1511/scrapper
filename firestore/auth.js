...
async function _performApiRequest(
  ...
  return _performFetchWithErrorHandling(auth, customErrorMap, () => {
    ...
    if (auth.languageCode) {
      headers.set(
        "X-Firebase-Locale" /* X_FIREBASE_LOCALE */,
        auth.languageCode
      );
    }
  ...
  static _fromError(authExtern, error) {
    ...
    return new MultiFactorResolverImpl(session, hints, async (assertion) => {
      ...
      const idTokenResponse = Object.assign(
        Object.assign({}, error.serverResponse),
        { idToken: mfaResponse.idToken, refreshToken: mfaResponse.refreshToken }
      );
...
function getMultiFactorResolver(auth, error) {
  ...
  _assert(
    (_a = errorInternal.serverResponse) === null || _a === void 0
      ? void 0
